...
/*
==================================================================================
This is the main index file for the theme
@mainly used for blog pages.
==================================================================================
*/
get_header();
...
/*
--------------------------------------------------------------------------------
Get the results for Forum type from theme options
--------------------------------------------------------------------------------
*/

$blog_type = mighty_mod_e_attr('mighty_bbpress_layout_type', 'blog_full_width');
                ...
                if ($blog_type) {
                    switch ($blog_type) {
                        case 'blog_full_width':
                            ...
                            echo '<div class="mighty_bbpress_content">';
